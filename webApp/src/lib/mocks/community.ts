...
export const COM = {
  ...
  threads: [
    ...
    { pin:false, cat:"ASTROLOGÍA",   moon:"◐", time:"hace V horas",   replies:23, title:"Plutón ingresando en Acuario — ¿lo están sintiendo?",            excerpt:"En lo personal noto que se removió todo lo vinculado a comunidad y al rol que juego dentro de los grupos.",    author:"Mariana T.", role:"ESTUDIANTE · ASTROLOGÍA" },
    { pin:false, cat:"TAROT",        moon:"○", time:"hace VIII horas", replies:19, title:"Cuando salen tres espadas seguidas en una tirada propia",        excerpt:"Necesito hablarlo. Tres tiradas, tres veces el VIII de Espadas en posición central. ¿Pausa?",                  author:"Cami R.",    role:"ESTUDIANTE · TAROT"  },
